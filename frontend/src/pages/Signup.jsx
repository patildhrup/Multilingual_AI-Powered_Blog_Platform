            ...
            <div className="flex-1 flex items-center justify-center p-6">
                ...
                >
                    ...
                    <div className="bg-[#1e293b] border border-[#334155] rounded-3xl p-8 shadow-2xl">
                        <h2 className="text-3xl font-black mb-2">{t("nav.signup")}</h2>
                        <p className="text-[#94a3b8] mb-8">Create an account to start writing.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#94a3b8] ml-1">Confirm Password</label>
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-[#475569]" size={20} />
                                    <input
                                        type="password"
