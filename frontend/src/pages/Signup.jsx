            ...
            <div className="flex-1 flex items-center justify-center p-6">
                ...
                >
                    ...
                    <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-2xl shadow-slate-200/50">
                        <h2 className="text-3xl font-black mb-2 text-black">{t("nav.signup")}</h2>
                        <p className="text-black/50 mb-8 font-medium">Create an account to start writing.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black text-black/40 ml-1 uppercase tracking-widest">Confirm Password</label>
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-black/20" size={20} />
                                    <input
                                        type="password"
                            ...
                            >
                                {loading ? <Loader2 className="animate-spin" size={20} /> : t("nav.signup")}
                            </button>
                        </form>
                        ...
                        <div className="mt-8 text-center text-black/40">
                            <p className="text-sm font-medium">
                                ...
                                <Link to="/login" className="text-indigo-600 font-black hover:underline uppercase tracking-widest text-xs">
                                    {t("nav.login")}
                                </Link>
                            </p>
                        </div>
